...
exports.updateTaskStatusController = exports.deleteTaskController = exports.getTaskByIdController = exports.getAllTasksController = exports.updateTaskController = exports.createTaskController = void 0;
...
const task_validation_2 = require("../validation/task.validation");
...
exports.updateTaskStatusController = (0, asyncHandler_middleware_1.asyncHandler)(async (req, res) => {
    const userId = req.user?._id;
    const taskId = task_validation_1.taskIdSchema.parse(req.params.id);
    const workspaceId = workspace_validation_1.workspaceIdSchema.parse(req.params.workspaceId);
    const { role } = await (0, member_service_1.getMemberRoleInWorkspace)(userId, workspaceId);
    (0, roleGuard_1.roleGuard)(role, [role_enum_1.Permissions.EDIT_TASK]);
    const status = task_validation_2.statusSchema.parse(req.body.status);
    const task = await (0, task_service_1.updateTaskStatusService)(workspaceId, taskId, status);
    return res.status(http_config_1.HTTPSTATUS.OK).json({
